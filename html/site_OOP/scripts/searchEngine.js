...
class Film {
    constructor(title, director, releaseYear, genre, roomNumber, rating) {
        this.title = title;
...
const films = [
    ...
    new Film("Dune", "Denis Villeneuve", 2023, "Sci-Fi", 28, 4),
    new Film("The Matrix", "Lana Wachowski", 2021, "Sci-Fi", 29, 4),
...
function linkFilmsToGrid(query = '', genre = '') {
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (searchInput) {
        searchInput.addEventListener('input', () => {
            ...
            linkFilmsToGrid(searchQuery, selectedGenre);
        });
    }
